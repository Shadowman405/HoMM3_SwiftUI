...
func getAllHeroes() -> [Hero] {
    let heroesArray = [
        ...
        Hero(id: 15, imageName: "Hero_Ingham", name: "Ingham", heroClass: "Cleric", heroSpec: "Monks", heroFirstSkill: "Basic Wisdom", heroSecondSkill: "Basic Mysticism", heroDescription: "Ingham maintained a modest monastery in the years before the Kreegan attack. He and his monks were quickly pressed into the service of the Erathian crown."),
        Hero(id: 16, imageName: "Hero_Loynis", name: "Loynis", heroClass: "Cleric", heroSpec: "Prayer", heroFirstSkill: "Basic Wisdom", heroSecondSkill: "Basic Learning", heroDescription: "Loynis has always believed that physical violence was never necessary as long as proper magic and prayer could be invoked. Amazingly enough, he made it work, and now is regarded as a successful, though unconventional, leader."),
        Hero(id: 17, imageName: "Hero_Rion", name: "Rion", heroClass: "Cleric", heroSpec: "First Aid", heroFirstSkill: "Basic Wisdom", heroSecondSkill: "Basic First Aid", heroDescription: "Rion worked as a battlefield medic in the Erathian Military, but proved his ability to command when his captain was slain fighting the Kreegan hordes. Rion was able to outmaneuver the enemy long enough for reinforcements to arrive."),
        Hero(id: 18, imageName: "Hero_Sanya", name: "Sanya", heroClass: "Cleric", heroSpec: "Eagle Eye", heroFirstSkill: "Basic Wisdom", heroSecondSkill: "Basic Eagle Eye", heroDescription: "Sanya has always been a fast learner, quickly outperforming first other students, then other acolytes once she had joined the church. She seems to have a natural ability to learn spells, sometimes merely by watching someone else cast them."),
        Hero(id: 19, imageName: "Hero_Clancy", name: "Clancy", heroClass: "Ranger", heroSpec: "Unicorns", heroFirstSkill: "Basic Resistance", heroSecondSkill: "Basic Pithfinding", heroDescription: "It was by pure accident that Clancy discovered he could communicate with Unicorns, but this unique ability has served him well as he worked his way through the ranks of AvLee's Military Elite.")
    ]
...
func getAllSpells() -> [Spell] {
    let spellsArray = [
        ...
        Spell(id: 25, name: "Disrupting Ray", imageName: "Disrupting_Ray", description: "Disrupting Ray is a 2nd level spell in the School of Air Magic. It reduces target, enemy creature stack's defense. Disrupting ray may be cast on same stack repeatedly, making it the only cumulative spell in Heroes of Might and Magic III. The effect of each cast stays until combat ends. It's prone to dispel/cure, and even if the target was killed and resurrected the disrupting ray effect still remains. Usually the overall effect is limited by zero defense level, but if the target's defense was buffed by spells or a defensive stance, it will go negative after the buffs expire.", spellLevel: 2, spellSchool: .AirMagic),
        Spell(id: 26, name: "Fire Wall", imageName: "Fire_Wall", description: "Fire Wall is a 2nd level spell in the School of Fire Magic.Produces a wall of fire. Any unit that's not immune to its effect that passes through it or ends their turn in it will take damage. Can only be removed by advanced/expert Remove Obstacle or expert Dispel.", spellLevel: 2, spellSchool: .FireMagic),
        Spell(id: 27, name: "Fortune", imageName: "Fortune", description: "Fortune is a 2nd level spell in the School of Air Magic. It increases luck of target, allied creature(s).", spellLevel: 2, spellSchool: .AirMagic),
        Spell(id: 28, name: "Ice Bolt", imageName: "Ice_Bolt", description: "Ice Bolt is a 2nd level spell in the School of Water Magic.", spellLevel: 2, spellSchool: .WaterMagic),
        Spell(id: 29, name: "Lightning Bolt", imageName: "Lightning_Bolt", description: "Lightning Bolt is a 2nd level spell in the School of Air Magic. Lightning Bolt is one of the game's direct damage spells.It should be noted, that the enemy can render his units immune to Lightning Bolt's effect with Pendant of Negativity.", spellLevel: 2, spellSchool: .AirMagic),
        Spell(id: 30, name: "Precision", imageName: "Precision", description: "Precision is a 2nd level spell in the School of Air Magic. It makes target allied creature stack(s) with ranged attack to increase their attack skill when using ranged attack.", spellLevel: 2, spellSchool: .AirMagic),
        Spell(id: 31, name: "Protection from Air", imageName: "Protection_from_Air", description: "Protection from Air is a 2nd level spell in the School of Air Magic. It reduces the damage target allied creature takes from spells in the school of air magic.", spellLevel: 2, spellSchool: .AirMagic),
        Spell(id: 32, name: "Quicksand", imageName: "Quicksand", description: "Quicksand is a 2nd level spell in the School of Earth Magic. The spell places quicksand pits randomly in combat field hexes. They are invisible to enemy hero, unless the hero has a creature fighting on native terrain. A creature stack that tries to move through a hex with quicksand pit is halted and cannot act until next round. Once a pit is stepped on, it is revealed for all to see. A unique property of the Quicksand spell is that it lasts infinitely during any battle, regardless of the user's spell power.AI cannot cast this spell.", spellLevel: 2, spellSchool: .EarthMagic),
        Spell(id: 33, name: "Remove Obstacle", imageName: "Remove_Obstacle", description: "Removes obstacles from the battlefield. Basic: Only trees, rocks and other natural obstacles may be removed. Advanced: May also remove fire walls.", spellLevel: 2, spellSchool: .WaterMagic),
        Spell(id: 34, name: "Scuttle Boat", imageName: "Scuttle_Boat", description: "Scuttle Boat is a 2nd level spell in the School of Water Magic. It destroys unoccupied boats.", spellLevel: 2, spellSchool: .WaterMagic),
        Spell(id: 35, name: "Weakness", imageName: "Weakness", description: "Weakness is a 2nd level spell in the School of Water Magic. It reduces the attack of target enemy stack.", spellLevel: 2, spellSchool: .WaterMagic)
    ]
